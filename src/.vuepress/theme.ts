...
export default hopeTheme({
  ...
  // author: {
  //   name: "Dongcp",
  //   url: "https://github.com/bojanyb",
  // },

  // 'Author',
  pageInfo: ['Date', 'Original', 'Word', 'ReadingTime', 'PageView', 'Category', 'Tag'],

  iconAssets: ['//at.alicdn.com/t/c/font_4010207_lnf1z756n8m.css'],
  ...
  blog: {
    ...
    // TODO
    // medias: {
    //   GitHub: "https://github.com/bojanyb",
