...
export default navbar([
    ...
    children: [
      ...
      },
      {
        ...
        children: [
          ...
          { text: 'BugMemoir', icon: '/assets/icon/bug.svg', link: '/BugMemoir/' },
        ],
      },
    ],
  },
...

  {
    ...
    children: [
      ...
      {
        text: 'SQL 数据库',
        children: [{ text: 'Mysql详解', icon: '/assets/icon/mysql.svg', link: '/Database/SQL/' }],
      },
      {
        text: 'NoSQL 数据库',
        children: [{ text: 'Redis详解', icon: '/assets/icon/redis.svg', link: '/Database/NoSQL/' }],
      },
    ],
  },
...

  {
    ...
    children: [
      {
        text: '框架',
        children: [{ text: 'Vue', icon: '/assets/icon/vue.svg', link: '/FrontEnd/Vue/' }],
      },
      {
        text: '理论知识',
        children: [
...

  {
    ...
    children: [
      {
        text: '功能设计',
        children: [{ text: '管理后台', icon: '/assets/icon/open1.png', link: '/Work/Admin/' }],
      },
    ],
  },
